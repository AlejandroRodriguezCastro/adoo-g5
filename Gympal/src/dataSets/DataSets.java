...
public class DataSets {
    ...
    private DataSets() {
        // SOCIOS
        Socio socio1 = new Socio("Alejandro", "Salgado", "40997301", 24, Sexo.MASCULINO, (float) 1.92);
        Socio socio2 = new Socio("Carla", "Estevez", "17154721", 55, Sexo.FEMENINO, (float) 1.65);
        Socio socio3 = new Socio("Ramon", "Espeche", "27523147", 43, Sexo.MASCULINO, (float) 1.72);
        ...
        Ejercicio ejercicio14 = new Ejercicio("Flexi�n con mancuernas", 3, 10, 5f, 4, ExigenciaMuscular.BAJA, GrupoMuscular.PECHO, "");
        ...
        Ejercicio ejercicio26 = new Ejercicio("Remo en m�quina", 3, 10, 35f, 6, ExigenciaMuscular.BAJA, GrupoMuscular.ESPALDA, "");
        ...
        Ejercicio ejercicio35 = new Ejercicio("Trasnuca con barra en m�quina", 3, 10, 15f, 5, ExigenciaMuscular.BAJA, GrupoMuscular.HOMBROS, "");
        Ejercicio ejercicio36 = new Ejercicio("Press militar", 4, 8, 40f, 6, ExigenciaMuscular.MEDIA, GrupoMuscular.HOMBROS, "");
        Ejercicio ejercicio37 = new Ejercicio("Remo al ment�n", 4, 10, 0f, 7, ExigenciaMuscular.BAJA, GrupoMuscular.HOMBROS, "");
        Ejercicio ejercicio38 = new Ejercicio("Encogimientos de hombros", 4, 10, 7.5f, 8, ExigenciaMuscular.MEDIA, GrupoMuscular.HOMBROS, "");
        Ejercicio ejercicio39 = new Ejercicio("Elevaciones laterales en m�quina", 3, 8, 20f, 9, ExigenciaMuscular.MEDIA, GrupoMuscular.HOMBROS, "");
        Ejercicio ejercicio40 = new Ejercicio("Flexiones para hombros", 4, 10, 0f, 10, ExigenciaMuscular.BAJA, GrupoMuscular.HOMBROS, "");


        // BRAZOS
        Ejercicio ejercicio41 = new Ejercicio("Curl para b�ceps con barra ol�mpica", 4, 10, 20f, 1, ExigenciaMuscular.ALTA, GrupoMuscular.BRAZOS, "");
        ...
        Ejercicio ejercicio48 = new Ejercicio("B�ceps con estocada posterior", 3, 8, 7.5f, 8, ExigenciaMuscular.MEDIA, GrupoMuscular.BRAZOS, "");
