...
public class Socio {
    private static int ultimoNroSocio = 123455;
    ...
    public Socio(String nombre, String apellido, String documento, Integer edad, Sexo sexo, Float altura) {
        ...
        this.nroSocio = Integer.toString(ultimoNroSocio);
    ...
    private Float obtenerPeso() {
        return mediciones.isEmpty() ? null : Optional.of(mediciones.get(mediciones.size() - 1).getPeso()).orElse(null);
    }

    private Float ultimoIMC() {
        return mediciones.isEmpty() ? null : Optional.of(mediciones.get(mediciones.size() - 1).getMasaMuscular()).orElse(null);
    }

    private Float ultimoGrasa() {
        return mediciones.isEmpty() ? null : Optional.of(mediciones.get(mediciones.size() - 1).getPorcentajeGrasaCorporal()).orElse(null);
    }
    ...
    public EntrenamientoDto comenzarEntrenamiento() {
        ...
        if (this.objetivo.getRutina() == null && obtenerPeso() != null) {

            this.objetivo.setPesoInicial(obtenerPeso());
            ...
            System.out.println(this.objetivo.getRutina() != null ? this.objetivo.getRutina().toString() : "no hay rutina establecida");
            this.objetivo.indicarObjetivo();
    ...
    public void setDiasDeEntrenamiento(List<Dias> diasDeEntrenamiento) {
    ...
    public String toString() {
        return "\nSocio [nombre=" + nombre + ", apellido=" + apellido + ", nroSocio=" + nroSocio + ", documento="
                + documento + ", edad=" + edad + ", sexo=" + sexo + ", altura=" + altura + ",diasDeEntrenamiento=" + (diasDeEntrenamiento!= null ? diasDeEntrenamiento.toString() : "no hay dias de entrenamiento") + ", \n mediciones="
                + mediciones + "]";
    }

    public SocioDto getSocioDto() {
        return new SocioDto(nombre, apellido, nroSocio, documento, edad, sexo, altura);
    }
